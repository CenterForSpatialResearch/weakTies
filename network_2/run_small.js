...
var simulation = d3.forceSimulation(nodes)
            ...
            .force("link", d3.forceLink(links).distance(2).strength(0.8).iterations(16))
            .force("x", d3.forceX())
            .force("y", d3.forceY())
.on("tick", ticked);
...
//   .force("y", d3.forceY().strength(0.02).y(height / 2))
      ...
      simulation.force("charge", d3.forceManyBody().strength(-80))
                .force("link", d3.forceLink(links).distance(distance).strength(0.9))
      .force("collide",d3.forceCollide().radius(10) .strength(0.2).iterations(16))
