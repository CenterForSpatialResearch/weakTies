	...
	function showCuisines(){
      ...
      function drawChords (matrix, mmap, data) {
		...
		var fontScale = d3.scale.sqrt().domain([0,maxForScale]).range([6,14])
        ...
        g.append("svg:text")
          ...
          function chordTip (d) {
            ...
            return "<div class = \"foodpair\">"+d.sname+" & "+ d.tname+"</div></br>"
			+ p(d.svalue/d.stotal) + " of menu items containing "+ d.sname 
